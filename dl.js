  ...
  tl.restart()
    ...
    .to(
      ...
      0.7,
      {
        attr: {
          d:
            "M50,25 h0 a10,10 0 0,1 10,10 a10,10 0 0,1 -10,10 s0,0 0,0  a10,10 0 0,1 -10,-10 a10,10 0 0,1 10,-10 h0"
        },
        ease: Sine.easeOut
      },
      "squeeze"
    ...
    .to(
      ...
      0.7,
      {
        attr: {
          d:
            "M20,39 l3.5,-3.5 l-3.5,-3.5 M20,39 l-3.5,-3.5 l3.5,-3.5 M20,39 l0,0"
        },
    ...
    .to(
      ...
      0.4,
      {
        attr: {
          d:
            "M50,25 h20 a10,10 0 0,1 10,10 a10,10 0 0,1 -10,10 s-20,0 -40,0 a10,10 0 0,1 -10,-10 a10,10 0 0,1 10,-10 h20"
        },
        ease: Power1.easeOut
      },
      "stretch+=.2"
    ...
    .to(btn, 0.01, { stroke: "#02fc86", ease: Power2.easeIn }, "stretch+=.87")
    .to(
      btn,
      0.3,
      {
        attr: {
          d:
            "M50,25 h20 a10,10 0 0,1 10,10 a12,12 0 0,1 -10,10.5 s-20,6 -40,0 a12,12 0 0,1 -10,-10.5 a10,10 0 0,1 10,-10 h20"
        },
        ease: CustomEase.create(
          "custom",
